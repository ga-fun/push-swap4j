...
2. Then it sorts the three remaining elements of A
...
2. Then it sorts the remaining elements of A
...
These results can be improved by keeping more elements in A during the first phase. The A sorting phase then uses a [BFS](https://en.wikipedia.org/wiki/Breadth-first_search) approach to find the optimal sequence of operations.
With a 7 elements kept in A, the results are:  
- 100 elements: 508 operations
- 500 elements: 4640 operations

### LisButterfly
A variant of Butterfly that pushes all the elements but the [longest increasing subsequence](https://en.wikipedia.org/wiki/Longest_increasing_subsequence) to B (this step replaces the 1 and 2 steps of Butterfly).  
...
## TODO
- [ ] Make final performance improvements in LisButterfly
- [ ] Implement K-sorter
