...
- [x] Fix test suite
- [ ] Fix refresh issue when moving in the move list selection (best/worse/neutral is lost).
- [ ] Input (numbers or moves) should be verified and rejected if invalid.
- [ ] Typing should be forbid in move fields (maybe a paste button should be added). One can corrupt the list by typing and there's Chrome typo warnings when clicking on a move.
