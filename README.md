...
- [ ] Some additing related materials should be migrated from pushSwapSim to listView (current idx, count, edit mode, title bar (with copy-clear buttons), addMove method).
- [ ] Diff selection should be cleared when list is edited.
